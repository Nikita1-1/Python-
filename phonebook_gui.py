...
def load_gui(self):
    ...
    self.lbl_fname.grid(rov=0, column=0, padx=(27,0), pady=(10,0),sticky=N+W)
    ...
    self.lbl_email = tk.Lable(self.master, text = 'Email Address:')
    self.lbl.email.grid(row=6, column=0, padx=(27,0),pady=(10,0),sticky=N+W)
    ...
    self.scrollbar1 = Scrollbar(sel.master, orient = VERTICAL)
